...
class ActionsBaseline:
    ...
    def parse_sector_timing(self, short_list: List[str]) -> None:
        ...
        first_backslash_n = find_indices_of_string(self.short_list, "\n")[0]

        for i in find_indices_of_string(_list=self.short_list, string="\n"):
            full_car = short_list[i - first_backslash_n:i]
            print(full_car)


def main() -> None:
    actions_baslines = ActionsBaseline()
    actions_baslines.parse_sector_timing(actions_baslines.short_list)
